    ...
    <main className="w-full">
      ...
      <section className="page-section-alt py-16 md:py-20 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8 md:mb-12">
            ...
            <p className="films-desc text-base md:text-lg mb-5">{t("filmsPage.schedule.subtitle", language)}</p>
            {/* Note "programme à venir" */}
            <div className="schedule-pending-note flex items-start gap-3 rounded-xl px-5 py-3.5 text-sm">
              <span className="flex-shrink-0 mt-0.5">📋</span>
              <span>{t("filmsPage.schedule.pendingNote", language)}</span>
            </div>
          </div>
          {isLoading ? (
      ...
      <section className="page-section py-16 md:py-20 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="films-desc text-sm mb-10 md:mb-12 italic">
            {t("filmsPage.activitiesSection.pendingNote", language)}
          </p>
          <Activities />
        </div>
      </section>
