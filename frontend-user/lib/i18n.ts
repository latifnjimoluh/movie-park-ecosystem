...
export const translations = {
  ...
  fr: {
    ...
    hero: {
      ...
      dateLabel: "Date",
      dateValue: "Vendredi 17 Avril 2026",
      locationLabel: "Lieu",
    ...
    whyCome: {
      ...
      subtitle: "Une expérience cinématographique unique qui allie divertissement, cœur et solidarité pour les orphelins",
      ...
      item4_title: "Une cause qui nous unit",
      item4_desc:
        "Chaque billet vendu et chaque don contribue directement au soutien des enfants orphelins de Yaoundé. Vivez le cinéma avec le cœur.",
    },
    ...
    pricing: {
      ...
      subtitle: "Des packs adaptés à tous les budgets — chaque achat soutient les orphelins de Yaoundé",
      charityNote: "♥ Partie des recettes reversée aux orphelins partenaires",
      choose: "Choisir",
    ...
    filmsPage: {
      ...
      schedule: {
        title: "Programme du 17 Avril 2026",
        subtitle: "Un programme en deux axes : activités pour les enfants orphelins & espace dédié aux encadrants",
        pendingNote: "📋 Programme détaillé disponible prochainement — retrouvez-nous après notre prochaine réunion de coordination !",

        s1: {
          time: "13h00 - 15h00",
          title: "🧒 Activités Enfants — Jeux & Animations",
          description: "Activités ludiques à venir — jeux, ateliers créatifs et animations spécialement conçus pour les orphelins participants.",
          category: "enfants",
        },
        s2: {
          time: "15h00 - 17h00",
          title: "👥 Espace Encadrants — Atelier & Échanges",
          description: "Session d'échange encadrants à venir — ateliers, discussions et partages d'expériences pour le personnel des orphelinats.",
          category: "encadrants",
        },
        s3: {
          time: "17h30",
          title: "Ouverture des portes — Grand Public",
          description: "Accueil du public, installation et préparation pour les projections",
        },
        s4: {
          time: "18h30",
          title: "Premier Film",
          description: "Zootopie 2 (2025) — séance famille, les orphelins et leurs encadrants aux premières loges",
        },
        s5: {
          time: "21h00",
          title: "Pause & Animations",
          description: "Repas, photobooth, mini-concours solidaires et rafraîchissements",
        },
        s6: {
          time: "22h00",
          title: "Deuxième Film",
          description: "Saw IV — séance nocturne (réservée au public adulte)",
        },
        s7: {
          time: "00h00+",
          title: "Clôture & Remerciements",
          description: "Fin de l'événement — remerciements aux orphelinats partenaires et remise symbolique des fonds collectés",
        },
      },
      ...
      activitiesSection: {
        ...
        pendingNote: "📋 Programme détaillé disponible prochainement",
      },
    ...
    aboutPage: {
      // Hero section
      hero: {
        title: "Édition Spéciale Orphelins — Movie in the Park",
        subtitle:
          "Le cinéma au service du cœur : découvrez comment Movie in the Park transforme chaque séance en acte de solidarité pour les enfants orphelins de Yaoundé",
      },

      // Qu'est-ce que Movie in the Park
      whatIs: {
        title: "C'est quoi Movie in the Park ?",
        p1: "Movie in the Park est un événement de cinéma en plein air à Yaoundé. Pour cette édition spéciale, nous unissons le divertissement à la solidarité : chaque billet vendu et chaque don contribuent directement au soutien des orphelins de notre ville. Une expérience unique sous les étoiles, mêlant films grand écran, concerts live, activités ludiques, zones photo, repas et boissons dans une ambiance festive et caritative.",
        p2: "Cette édition spéciale réunit familles, amis, couples et passionnés de cinéma autour d'une cause commune. Nous travaillons en partenariat avec des orphelinats locaux pour que les fonds récoltés leur soient directement reversés. Le but : vivre une soirée inoubliable tout en faisant une vraie différence dans la vie des enfants.",
        nextEditionTitle: "🤍 Édition Spéciale Orphelins — 17 Avril 2026 — Yaoundé",
        nextEditionSubtitle: "Chaque place réservée, chaque don reçu change une vie. Rejoignez-nous !",
        clothingTitle: "🤝 Nos partenariats orphelinats",
        clothingText:
          "Nous collaborons avec des orphelinats partenaires de Yaoundé. Une partie des recettes de billetterie leur est reversée, et un représentant de chaque orphelinat sera présent lors de l'événement pour témoigner de l'impact de votre générosité.",
      },
      ...
      visionValues: {
        ...
        qualityTitle: "Solidarité",
        qualityText:
          "Cette édition spéciale place la solidarité au cœur de l'événement. Chaque achat contribue à améliorer les conditions de vie des orphelins de Yaoundé.",

        innovationTitle: "Impact",
        innovationText:
          "Mesurer et communiquer l'impact réel de chaque don et billet vendu : nombre d'enfants aidés, projets financés, témoignages de terrain.",
      },
      ...
      // Call to action
      cta: {
        title: "Rejoignez-nous & faites une différence !",
        subtitle: "Réservez votre place ou faites un don — chaque geste compte pour les orphelins de Yaoundé",
        button: "Réserver ma place",
        donButton: "Faire un don",
      },
    },

    // --------------------------------------------------------------------------
    // PAGE DON (Formulaire de don caritatif)
    // --------------------------------------------------------------------------
    donPage: {
      hero: {
        badge: "🤍 Édition Spéciale Orphelins",
        title: "Soutenir les orphelins",
        subtitle:
          "Votre générosité change des vies. Chaque don, petit ou grand, contribue directement au bien-être des enfants orphelins de Yaoundé.",
      },

      impact: {
        title: "Votre don en action",
        item1: "Fournitures scolaires pour les enfants",
        item2: "Repas chauds et équipements",
        item3: "Activités culturelles et éducatives",
      },

      form: {
        title: "Faire un don",
        subtitle: "Remplissez le formulaire, puis effectuez votre paiement Mobile Money",
        nameLabel: "Votre nom (optionnel)",
        namePlaceholder: "Reste anonyme si tu le souhaites",
        emailLabel: "Email (optionnel)",
        emailPlaceholder: "Pour recevoir votre reçu de don",
        amountLabel: "Montant du don (XAF) *",
        ...
        submitButton: "Confirmer mon don",
      ...
      success: {
        ...
        message:
          "Votre intention de don a été enregistrée. Effectuez maintenant votre paiement Mobile Money et envoyez votre reçu sur WhatsApp.",
        whatsappButton: "Envoyer mon reçu sur WhatsApp",
    ...
    // --------------------------------------------------------------------------
    // POPUP ÉDITION SPÉCIALE
    // --------------------------------------------------------------------------
    specialEditionPopup: {
      badge: "✨ Nouveau",
      title: "Édition Spéciale Orphelins",
      subtitle:
        "Movie in the Park s'engage cette année pour une cause qui touche le cœur : le soutien aux enfants orphelins de Yaoundé.",
      highlight: "Chaque billet vendu et chaque don contribuent directement à leur bien-être.",
      ctaDon: "Faire un don",
      ctaReservation: "Réserver ma place",
      close: "Continuer vers le site",
    },
  ...
  en: {
    ...
    hero: {
      ...
      dateLabel: "Date",
      dateValue: "Friday, April 17, 2026",
    ...
    whyCome: {
      ...
      subtitle: "A unique outdoor cinema experience blending entertainment, heart and solidarity for orphaned children",
      ...
      item4_title: "A cause that unites us",
      item4_desc:
        "Every ticket sold and every donation goes directly toward supporting orphaned children in Yaoundé. Experience cinema with heart.",
    },
    ...
    pricing: {
      ...
      subtitle: "Packages for all budgets — every purchase supports the orphaned children of Yaoundé",
      charityNote: "♥ Part of proceeds donated to our orphanage partners",
      choose: "Choose",
    ...
    filmsPage: {
      ...
      schedule: {
        title: "Program — April 17, 2026",
        subtitle: "A two-track program: children's activities for orphans & a dedicated space for caregivers",
        pendingNote: "📋 Full schedule coming soon — check back after our next coordination meeting!",

        s1: {
          time: "1:00 PM – 3:00 PM",
          title: "🧒 Children's Activities — Games & Animations",
          description: "Coming soon — games, creative workshops and entertainment specially designed for the orphaned children attending.",
          category: "enfants",
        },
        s2: {
          time: "3:00 PM – 5:00 PM",
          title: "👥 Caregivers Space — Workshop & Exchanges",
          description: "Coming soon — workshops, discussions and experience sharing for orphanage staff.",
          category: "encadrants",
        },
        s3: {
          time: "5:30 PM",
          title: "Doors Open — General Public",
          description: "Public welcome, seating, and preparation for the screenings",
        },
        s4: {
          time: "6:30 PM",
          title: "First Movie",
          description: "Zootopia 2 (2025) — family screening, orphans and caregivers in front seats",
        },
        s5: {
          time: "9:00 PM",
          title: "Break & Animations",
          description: "Food, photobooth, solidarity mini-contests and refreshments",
        },
        s6: {
          time: "10:00 PM",
          title: "Second Movie",
          description: "Saw IV — night screening (adult audience only)",
        },
        s7: {
          time: "12:00 AM+",
          title: "Closing & Thank You",
          description: "End of event — acknowledgement of partner orphanages and symbolic donation handover",
        },
      },
      ...
      activitiesSection: {
        ...
        pendingNote: "📋 Full schedule coming soon",
      },
    ...
    aboutPage: {
      // Hero section
      hero: {
        title: "Special Orphans Edition — Movie in the Park",
        subtitle:
          "Cinema in the service of the heart: discover how Movie in the Park turns every screening into an act of solidarity for orphaned children in Yaoundé",
      },

      // What is Movie in the Park
      whatIs: {
        title: "What is Movie in the Park?",
        p1: "Movie in the Park is an open-air cinema event in Yaoundé. For this special edition, we unite entertainment with solidarity: every ticket sold and every donation directly contributes to supporting the orphaned children of our city. A unique experience under the stars, mixing big-screen movies, live concerts, games, photo zones, food, and drinks in a festive and charitable atmosphere.",
        p2: "This special edition brings together families, friends, couples, and movie lovers around a shared cause. We partner with local orphanages so that the funds raised go directly to them. The goal: enjoy an unforgettable night while making a real difference in children's lives.",
        nextEditionTitle: "🤍 Special Orphans Edition — April 17, 2026 — Yaoundé",
        nextEditionSubtitle: "Every ticket booked, every donation received changes a life. Join us!",
        clothingTitle: "🤝 Our orphanage partnerships",
        clothingText:
          "We collaborate with partner orphanages in Yaoundé. A portion of ticket revenue is donated to them, and a representative from each orphanage will be present at the event to share the impact of your generosity.",
      },
      ...
      visionValues: {
        ...
        qualityTitle: "Solidarity",
        qualityText:
          "This special edition places solidarity at the heart of the event. Every purchase contributes to improving the living conditions of orphaned children in Yaoundé.",

        innovationTitle: "Impact",
        innovationText:
          "Measure and communicate the real impact of each donation and ticket sold: number of children helped, projects funded, field testimonials.",
      },
      ...
      cta: {
        ...
        subtitle: "Reserve your seat or make a donation — every gesture counts for the orphaned children of Yaoundé",
        button: "Reserve my seat",
        donButton: "Make a donation",
      },
    },
    ...
    donPage: {
      hero: {
        badge: "🤍 Special Orphans Edition",
        title: "Support the orphaned children",
        subtitle:
          "Your generosity changes lives. Every donation, big or small, directly contributes to the well-being of orphaned children in Yaoundé.",
      },

      impact: {
        title: "Your donation in action",
        item1: "School supplies for the children",
        item2: "Warm meals and equipment",
        item3: "Cultural and educational activities",
      },

      form: {
        title: "Make a donation",
        subtitle: "Fill in the form, then complete your Mobile Money payment",
        nameLabel: "Your name (optional)",
        namePlaceholder: "Stay anonymous if you wish",
        emailLabel: "Email (optional)",
        emailPlaceholder: "To receive your donation receipt",
        amountLabel: "Donation amount (XAF) *",
        ...
        submitButton: "Confirm my donation",
        submitting: "Saving…",
      },
      ...
      success: {
        ...
        message:
          "Your donation intention has been recorded. Now complete your Mobile Money payment and send your receipt on WhatsApp.",
        whatsappButton: "Send my receipt on WhatsApp",
    ...
    specialEditionPopup: {
      badge: "✨ New",
      title: "Special Orphans Edition",
      subtitle:
        "Movie in the Park is committed this year to a cause that touches the heart: supporting orphaned children in Yaoundé.",
      highlight: "Every ticket sold and every donation directly contributes to their well-being.",
      ctaDon: "Make a donation",
      ctaReservation: "Reserve my spot",
      close: "Continue to the site",
    },
